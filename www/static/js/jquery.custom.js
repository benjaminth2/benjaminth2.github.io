...
$(document).ready(function(){
	document.addEventListener("deviceready", function () {
		app.Init();
		console.log("deviceready ready")
	  DataInitUtil.initButtonConfigData();

      if (window.cordova.platformId != 'android') {
        window.app.DataInitUtil.initData();
      }
      //获取权限
        ...
        new Promise(function (resolve, reject) {
          ...
          if (window.cordova != null) {
            ...
            console.log("获取权限状态:"+status)
        }).catch(function () {

          //获取权限失败！！！
          console.log('permission request fail')
        });
	...
	// LOAD PANEL LEFT
	$( "#panel-left" ).load( "panel-left.html" );
